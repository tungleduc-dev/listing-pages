@if (setting('payment_stripe_status') == 1)
    <li class="list-group-item">
        ...
        <div class="payment_stripe_wrap payment_collapse_wrap collapse @if ((session('selected_payment_method') ?: setting('default_payment_method')) == STRIPE_PAYMENT_METHOD_NAME) show @endif">
